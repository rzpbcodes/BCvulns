...
*Instances (1)*:
```solidity
File: bypassProofRequirement.sol

23:         (bool pass, ) = recipient.call{value: amount}("");
...
15:         require(proofRoot == trustedRoot || proofRoot == bytes32(0x00), "Invalid proof");

17:         require(!processedTxs[txHash], "Already processed");

24:         require(pass, "Transfer failed");
